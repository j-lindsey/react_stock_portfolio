            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <form className="col-12 mt-2 mb-4" onSubmit={this.addStock}>
                        <div className="row">
                            <div className="col-12 col-md-4 col-lg-2 mx-2 d-flex flex-md-column justify-content-between justify-content-md-start">
                                <label>Name</label>
                                <input
                                    name="name"
                                    type="text"
                            ...
                            <div className="col-12 col-md-4 col-lg-2 mx-2 d-flex align-items-end">
